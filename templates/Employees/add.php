<?php $this->assign('title', 'Add Employee Data'); ?>
...
<div class="container py-5">
    ...
    <h3 class="text-center mb-3"><strong>Add Employee Data</strong></h3>
    <?= $this->Flash->render() ?>
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 mb-3">
            <?= $this->Form->control('district_id', ['label' => 'District*', 'empty' => 'Select District', 'options' => [], 'class' => 'form-select', 'id' => 'district_id']); ?>
        </div>
        <div class="col-md-4 col-sm-6 mb-3">
        ...
        <div class="col-md-12 mb-3">
            ...
            <?= $this->Form->reset('Reset', ['class' => 'btn btn-warning']) ?>
